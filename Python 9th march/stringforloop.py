#methods-count,find, replace,join,index,split,splitlines,
#iterate string
name="Itvedant"
# for i in name:
#     print(i)
...
#WAP to print number of occurances of entered character from any string
...
#WAP to print number of occurances of entered character or word from any string
str=input("Enter String=")
